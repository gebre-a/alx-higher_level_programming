...
class Rectangle:
    """
    Class that describes properties of rectangle by: (based on 8-rectangle.py).
    ...
    def width(self, value):
        """Property setter for rectangles width.
    ...
    def square(cls, size=0):
        ...
        Args:
            ...
            size (int): size of rectangle (1 side). Defaults to 0.
    ...
    def __repr__(self):
        """Returns a rectangles string representation.
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Computes the two area of rectangles and compares them.
